...
int pqcrystals_dilithium2_lowram_keypair_from_seed(const void*seed, uint8_t *pk, uint8_t *sk);
...
int pqcrystals_dilithium3_lowram_keypair_from_seed(const void*seed, uint8_t *pk, uint8_t *sk);
...
int pqcrystals_dilithium5_lowram_keypair_from_seed(const void*seed, uint8_t *pk, uint8_t *sk);
